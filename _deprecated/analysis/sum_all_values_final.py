...
# Estratégia diferente: somar TODOS os valores monetários na seção, ignorando datas
# Isso vai nos dar o total real do PDF
invoice_year = 2025
all_values = []
...
print(f"\nTotal valores positivos: {total_positive}")
