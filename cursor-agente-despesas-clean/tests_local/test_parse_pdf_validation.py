#!/usr/bin/env python3
"""
Script de teste para validar o parsing do PDF contra o output esperado.
...
def main():
    ...
    pdf_path = workspace / 'fatura_cartao.pdf'
    output_path = workspace / 'parse_output.json'
    expected_path = workspace / 'tests' / 'output_esperado.json'
    
    print("=" * 80)
    print("  Teste de Validação do Parser de PDF Itaú")
    print("=" * 80)
    print()
    ...
    if not differences:
        ...
        print("=" * 80)
        print("  RESULTADO: FALHA - Outputs são diferentes!")
        print("=" * 80)
        return 1
